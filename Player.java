...
public class Player 
{
	...
	public Player()
	{
		...
		allCards.add(new CreatureCard("Experimental Pilot","blue",1,1,1));
		allCards.add(new CreatureCard("Experimental Pilot","blue",1,1,1));
		...
		allCards.add(new CreatureCard("Backstreet Bruiser","blue",2,2,3));
		allCards.add(new CreatureCard("Backstreet Bruiser","blue",2,2,3));
		allCards.add(new CreatureCard("Big Trucking Wall","blue",5,0,12));
		allCards.add(new CreatureCard("Big Trucking Wall","blue",5,0,12));
		allCards.add(new CreatureCard("Big Trucking Wall","blue",5,0,12));
		...
		allCards.add(new CreatureCard("Phantom Carriage","When Phantom Carraige enters the battlefield, draw a card.","blue",4,3,3,"draw"));
		allCards.add(new CreatureCard("Rapid Swinger","blue",4,6,2));	
	...
	public void fillDeck(String colorDeck)
	{
				...
				else if(colorDeck.equals("blue"))
				{
					...
					deck.add(new CreatureCard("Experimental Pilot","blue",1,1,1));
					deck.add(new CreatureCard("Experimental Pilot","blue",1,1,1));
					...
					deck.add(new CreatureCard("Backstreet Bruiser","blue",2,2,3));
					deck.add(new CreatureCard("Backstreet Bruiser","blue",2,2,3));
					deck.add(new CreatureCard("Big Trucking Wall","blue",5,0,12));
					deck.add(new CreatureCard("Big Trucking Wall","blue",5,0,12));
					deck.add(new CreatureCard("Big Trucking Wall","blue",5,0,12));
					...
					deck.add(new CreatureCard("Phantom Carriage","When Phantom Carraige enters the battlefield, draw a card.","blue",4,3,3,"draw"));
					deck.add(new CreatureCard("Rapid Swinger","blue",4,6,2));	
